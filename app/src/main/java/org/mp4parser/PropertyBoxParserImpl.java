...
import com.lukeneedham.videodiary.AppContext;
...
public class PropertyBoxParserImpl extends AbstractBoxParser {
    ...
    public PropertyBoxParserImpl(String... customProperties) {
        ...
        if (BOX_MAP_CACHE != null) {
            ...
            // This is changed because doing `getSystemResourceAsStream` fails on Android for some reason
            // See: https://github.com/sannies/mp4parser/issues/263
            InputStream is;
            try {
                is = AppContext.INSTANCE.getValue().getAssets().open("isoparser2-default.properties");
            } catch (IOException e) {
